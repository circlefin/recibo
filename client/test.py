...
class ReciboTest(unittest.TestCase):
    ...
    def test_get_events_for(self):
        ...
        # check events
        (transfer_events, approve_events) = self.recibo.get_events_for(receiver.address)
    ...
    def test_get_transaction_and_decrypt_tx(self):
        ...
        # decrypt transaction
        plaintext = self.recibo.decrypt_tx(tx_hash, receiver.encrypt_key, receiver.password)
        self.assertEqual(plaintext, message)
